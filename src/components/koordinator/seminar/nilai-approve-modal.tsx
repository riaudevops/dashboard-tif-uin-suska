...
interface NilaiApproveModalProps {
  isOpen: boolean;
  onClose: () => void;
  student: {
    id: number;
...
const NilaiApproveModal: FC<NilaiApproveModalProps> = ({
  isOpen,
  onClose,
  student,
}) => {
        ...
        <div className="overflow-y-auto flex-1 px-4  bg-gray-50 dark:bg-gray-900">
          ...
          <div className="flex items-center space-x-2 justify-center p-4 ">
            ...
            <label className="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
              CENTANG INI JIKA NILAI SUDAH DI INPUT DI IRASE !
            </label>
          </div>
...
export default NilaiApproveModal;
